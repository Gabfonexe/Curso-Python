filmsTuple = ("Bob esponja", "Os simpsons", "Meu malvado favorito", "Carros", "Cinderela", "Bela e a Fera", "Elementos", "Frozen", "Moana", "Star Wars", "Harry Potter", "A lenda dos guardiões", "Uma noite no Museu", "Jumper")
